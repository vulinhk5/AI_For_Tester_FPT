...
| **Khả năng tùy chỉnh** | Không đề cập | **UI:** Hỗ trợ nhiều định dạng đầu ra (Steps, Text, BDD) và Preview để chọn/lọc Test Case trước khi import.<br>**Backend:** Không thể can thiệp vào model hoặc cách AI suy luận; chất lượng phụ thuộc vào Prompt. | Không đề cập |
